...
func TrdPlaceOrderSend(conn *futugg.FutuGG, trdEnv int32, accID uint64, trdMarket int32, trdSide int32, orderType int32, code string, qty float64, price float64, secMarket int32, auxPrice float64) error {
